...
{   
    ...
    public internal static class ExecuteReaderCommand2
    {
        // Define an activity input argument of type string
        ...
        public static object ExecuteReader<T>(this Database obj,String SqlCommandString,bool CloseConnectionOnDone)
        {
            // Obtain the runtime value of the Text input argument
