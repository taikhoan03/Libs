...
{   
    ...
    /// Not work yet
    /// </summary>
    public sealed class ExecuteReaderCommand : CodeActivity<Type>
    {
        // Define an activity input argument of type string
        public InArgument<string> SqlCommandString { get; set; }
        public InArgument<T> InputType { get; set; }
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            var list = context.GetValue(this.InputType).CreateInstance();
    ...
    {
        public static List<T> CreateInstance<T>(this T me)
        {
            var listType = typeof(List<>);
            var constructedListType = listType.MakeGenericType(listType);
