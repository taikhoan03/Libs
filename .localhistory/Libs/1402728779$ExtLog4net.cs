...
namespace Libs
{
    ...
    {
        private static readonly ILog extlog = LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod
().DeclaringType);
        ...
        public static void LogError(string str, Exception ex = null)
        {
            if (ex == null)
            {
                extlog.Error(str);
