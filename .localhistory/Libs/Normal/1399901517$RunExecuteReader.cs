...
namespace Libs
{
    ...
    public static class ExtMethods//:System.Activities.Activity
    {
        public static object ExecuteReader<T>(this Database obj, String command)
        {
            ...
            aaa.SqlCommandString = DB.DBParameters.Conn.ConnectionString;
            //aaa
        ...
        private static object merge(Npgsql.NpgsqlDataReader dbObject, object DestinationClassObject)
        {
            //reinit some properties
            Npgsql.NpgsqlDataReader dr = dbObject;
