...
namespace Libs
{
    ...
    public static class ExtMethods
    {
        ...
        /// <returns></returns>
        public static T XMLStringToObject<T>(this string objectToSerialize,string xml)
        {
        ...
        /// <returns></returns>
        public static List<T> XMLStringToListObject<T>(this T objectToSerialize, string xml)
        {
